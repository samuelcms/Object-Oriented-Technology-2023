package le06.exercicios.ex02;

import static java.lang.String.format;
import static le06.entradaesaida.EntradaSaida.*;
import static javax.swing.SwingConstants.*;

import le06.exercicios.ex01.Signo;
...
public class Zodiaco 
{
	...
	private void obterSigno()
	{
		...
		if(dataNascimento != null && !dataNascimento.isBlank())
			msgInfo(format("Seu signo é: %s",Signo.obterSigno(dataNascimento)), dataNascimento);
	}
	...
	private void obterSignos()
	{
		...
		exibirTabela("", Signo.obterSignos(), colunas, larguraColunas, alinhamento, 230, 100);
	}
}
